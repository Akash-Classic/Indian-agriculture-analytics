This project showcases Indian agriculture analytics using Mantine, a React component library, to display data tables aggregated from the National Data and Analytics Platform (NDAP) provided by NITI Aayog.
